...
request.onupgradeneeded = function(event) {
  ...
  //create a new object store called new_transaction, set it to have auto increment key
  db.createObjectStore('budget_tracker_pwa', { autoIncrement: true });
};

// if successful
request.onsuccess = function(event) {
  // when db is successfully created with its object store (from on up graded needed event above), save reference to db in global variable
